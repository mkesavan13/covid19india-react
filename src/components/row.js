...
const isDistrictRowEqual = (prevProps, currProps) => {
  ...
  if (!equal(currProps.regionHighlighted?.slno, currProps.slno)) {
    return false;
  }
  return true;
};
...
const isEqual = (prevProps, currProps) => {
  ...
  if (prevProps.slno === undefined || prevProps.slno !== currProps.slno) {
    return false;
  }
  return true;
};
      ...
      {showDistricts &&
        Object.keys(sortedDistricts).map((district, index) => (
          <DistrictRow
            ...
            state={state}
            index={index}
            slno={sortedDistricts[district]['slno']}
            district={district}
            districts={districts}
            zone={zones[district]}
